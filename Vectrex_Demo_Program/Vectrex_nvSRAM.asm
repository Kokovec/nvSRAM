...
; Instead, it uses what is normaly Vectrex ROM space for RAM.
; This program won't work with a PROM, it must use some type of SRAM
; When using with nvSRAM, variable states will be maintained between power cycles
;
